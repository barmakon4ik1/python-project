...
def main_program():
    ...
    print("|     Но не знаешь что посмотреть? Тогда ты пришел правильно    |")
...
if __name__ == '__main__':
    while True:
        print("\nПрограмма будет выполняться до тех пор, пока не будет введено 00 для выхода (2 нуля): \n")
        exit_cond = input("Хочешь выйти? Нажми 00. Все остальное запустит программу. Твой выбор? : \n")
        if exit_cond == '00':
